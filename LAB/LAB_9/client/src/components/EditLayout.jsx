...
function EditLayout(props) {
    ...
    let film = filmId && props.listFilms.find(film => film.id === parseInt(filmId));
    ...
    let handleOnSubmit = (event) => {
        ...
        if (date === undefined || date === '') {
            ...
            let film = { id: parseInt(filmId), title: title, watchDate: dayjs(date), isFavorite: favorite, score: rating };
